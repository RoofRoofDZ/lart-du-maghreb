...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	...
	$wp_customize->add_control(new onlineclothingshop_Tab_Control($wp_customize, 'onlineclothingshop_collection_tabs', array(
	   ...
	   'buttons' => array(
		 ...
		 array(
		   'name' => esc_html__('Layout', 'online-clothing-shop'),
		   'icon' => 'dashicons dashicons-layout',
		   'fields' => array(
			   'collection_section_width',
			   'onlineclothingshop_collection_padding',
			   'onlineclothingshop_collection_top_padding',
			   'onlineclothingshop_collection_bottom_padding'
		   ),
		)
    	),
	))); 
    ...
    $wp_customize->add_control(
        new onlineclothingshop_Toggle_Switch_Custom_Control(
            $wp_customize,
            'collection_disable_section',
            array(
                'settings'      => 'collection_disable_section',
                'section'       => 'collection_setting',
                'label'         => __( 'Disable Section', 'online-clothing-shop' ),
                'on_off_label'  => array(
                    'on' => __( 'Yes', 'online-clothing-shop' ),
                    'off' => __( 'No', 'online-clothing-shop' )
                ),
            )
        )
    );
	...
	$wp_customize->add_setting('collection_section_width',array(
        'default' => 'Box Width',
        'sanitize_callback' => 'onlineclothingshop_sanitize_choices',
    ));
    $wp_customize->add_control('collection_section_width',array(
        'type' => 'select',
        'label' => __('Section Width','online-clothing-shop'),
        'choices' => array (
            'Box Width' => __('Box Width','online-clothing-shop'),
            'Full Width' => __('Full Width','online-clothing-shop')
        ),
        'section' => 'collection_setting',
    ));
	...
	$wp_customize->add_setting('onlineclothingshop_collection_padding',array(
		'sanitize_callback'   => 'esc_html'
	));
	$wp_customize->add_control('onlineclothingshop_collection_padding',array(
		'label' => __('Section Padding','online-clothing-shop'),
		'section' => 'collection_setting'
	));

	$wp_customize->add_setting('onlineclothingshop_collection_top_padding',array(
		'default' => '0',
		'sanitize_callback' => 'sanitize_text_field'
	));
	$wp_customize->add_control('onlineclothingshop_collection_top_padding',array(
		'type' => 'number',
		'label' => __('Top','online-clothing-shop'),
		'section' => 'collection_setting',
	));

		$wp_customize->add_setting('onlineclothingshop_collection_bottom_padding',array(
		'default' => '0',
		'sanitize_callback' => 'sanitize_text_field'
	));
	$wp_customize->add_control('onlineclothingshop_collection_bottom_padding',array(
		'type' => 'number',
		'label' => __('Bottom','online-clothing-shop'),
		'section' => 'collection_setting',
	));
