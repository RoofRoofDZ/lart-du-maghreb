...
function onlineclothingshop_header_style() {
	...
	<style type="text/css">
		...
		#collection-section {
			padding-top: <?php echo esc_attr(get_theme_mod('onlineclothingshop_collection_top_padding')); ?>em !important;
		}

		#collection-section {
			padding-bottom: <?php echo esc_attr(get_theme_mod('onlineclothingshop_collection_bottom_padding')); ?>em !important;
		}
